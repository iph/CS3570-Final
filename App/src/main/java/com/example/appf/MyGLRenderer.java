...
//        float angle = 0.090f * ((int) time);
        //Matrix.setRotateM(mRotationMatrix, 0, 60, 1.0f, 0.0f, 0.0f);
...
class Shape {
    //float[] modelMatrix = Matrix.setIdentityM(new float[16], );
    int glProgram;
...
class Triangle {
    ...
    public void draw(float[] mvpMatrix, float mAngle) {
        ...
        Matrix.setRotateM(rotation, 0, mAngle, 0.0f, 1.0f, 00f);
        //Log.e("glz", Arrays.toString(rotation));
